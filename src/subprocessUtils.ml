...
(**
   ...
   By default, this function always returns an empty string for the program
   ouptut.  If the optional get_output argument is set to true, this function
   will instead open the written log file, retrieve the contents, and provide
   them as the program output.
